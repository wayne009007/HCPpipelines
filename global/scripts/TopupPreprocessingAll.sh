...
# check if SBRef is not set to none
...
# skip all this if SBRef (Scout) is set to none, which is when Phase images are different dimensions compared to SBRef (Scout)
if [ ! $ScoutInputName = "NONE" ] ; then
