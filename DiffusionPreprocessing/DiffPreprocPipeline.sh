...
PARAMETERs are: [ ] = optional; < > = user supplied value
  ...
  [--combine-data-flag=<value>]
                          ...
                          Defaults to 1
                          3 - include in the output only volumes from the direction 
                              with more slices; useful for data where one direction 
                              has much more volumes then the other, e.g. 100 vs. 10
